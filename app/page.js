    ...
    <main>
      <section className="grid sm:grid-cols-2 h-[70vh] py-1 ">
        ...
        <div className=" bg-purple-100 flex flex-col gap-4 items-center justify-center text-center">
          ...
          <p className=" px-11 text-2xl text-center font-medium">We are best url shortner in the word. In most of urls shortner you have to login but we understand your needs you can shorten your urls easily</p>
